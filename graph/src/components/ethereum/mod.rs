...
pub use self::types::{
    EthereumBlock, EthereumBlockData, EthereumBlockPointer, EthereumBlockWithCalls,
    EthereumBlockWithTriggers, EthereumCall, EthereumEventData, EthereumTransactionData,
    EthereumTrigger,
};

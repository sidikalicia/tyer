...
struct EthereumContractMappingEntity {
    ...
    block_handler: Option<EthereumBlockHandlerEntity>,
    call_handlers: Vec<EthereumCallHandlerEntity>,
...
#[derive(Debug)]
struct EthereumBlockHandlerEntity {
    handler: String,
}
...
#[derive(Debug)]
struct EthereumCallHandlerEntity {
    function: String,
    handler: String,
}

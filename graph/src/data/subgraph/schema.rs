...
use crate::data::store::{Entity, NodeId, SubgraphEntityPair, TryFromEntity, Value, ValueType};
...
impl TryFromEntity for SubgraphManifestEntity {
    fn try_from_entity(entity: Entity) -> Result<Self, Error> {
        Ok(Self {
            spec_version: entity.get_string("specVersion")?,
            description: entity.get_optional_string("description")?,
            repository: entity.get_optional_string("repository")?,
            schema: entity.get_string("schema")?,
            data_sources: vec![],
        })
    }
}
...
impl TryFromValue for EthereumContractDataSourceEntity {
    fn try_from_value(value: &q::Value) -> Result<Self, Error> {
        let map = match value {
            ...
            _ => Err(format_err!("Cannot parse value into a data source entity: {:?}", value)),
        }?;
...
impl TryFromValue for EthereumContractSourceEntity {
    fn try_from_value(value: &q::Value) -> Result<Self, Error> {
            let map = match value {
                q::Value::Object(map) => Ok(map),
                _ => Err(format_err!("Cannot parse value into a contract source entity: {:?}", value)),
            }?;
...
impl TryFromValue for EthereumContractMappingEntity {
    fn try_from_value(value: &q::Value) -> Result<Self, Error> {
        let map = match value {
            q::Value::Object(map) => Ok(map),
            _ => Err(format_err!("Cannot parse value into a mapping entity: {:?}", value)),
        }?;
...
impl TryFromValue for EthereumContractAbiEntity {
    fn try_from_value(value: &q::Value) -> Result<Self, Error> {
        let map = match value {
            q::Value::Object(map) => Ok(map),
            _ => Err(format_err!("Cannot parse value into ABI entity: {:?}", value)),
        }?;
...
impl TryFromValue for EthereumContractEventHandlerEntity {
    fn try_from_value(value: &q::Value) -> Result<Self, Error> {
        let map = match value {
            q::Value::Object(map) => Ok(map),
            _ => Err(format_err!("Cannot parse value into event handler entity: {:?}", value)),
        }?;
...
impl TryFromValue for EthereumContractDataSourceTemplateEntity {
    fn try_from_value(value: &q::Value) -> Result<Self, Error> {
        let map = match value {
            q::Value::Object(map) => Ok(map),
            _ => Err(format_err!("Cannot parse value into a data source template entity: {:?}", value)),
        }?;
...
impl TryFromValue for EthereumContractDataSourceTemplateSourceEntity {
    fn try_from_value(value: &q::Value) -> Result<Self, Error> {
        let map = match value {
            q::Value::Object(map) => Ok(map),
            _ => Err(format_err!("Cannot parse value into a template source entity: {:?}", value)),
        }?;

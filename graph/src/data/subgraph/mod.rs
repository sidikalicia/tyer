...
use crate::data::subgraph::schema::{EthereumContractDataSourceEntity, EthereumContractSourceEntity, EthereumContractMappingEntity, EthereumContractAbiEntity, EthereumContractEventHandlerEntity, EthereumContractDataSourceTemplateEntity, EthereumContractDataSourceTemplateSourceEntity};
...
impl From<EthereumContractDataSourceEntity> for UnresolvedDataSource {
    fn from(entity: EthereumContractDataSourceEntity) -> Self {
        Self {
            ...
            templates: entity.templates.map(|templates| templates.into_iter().map(Into::into).collect()),
        }
    }
}
